...
test "g++ -std=c++14 -O2 -march=native -DTKLB_TEST"
test "g++ -std=c++14 -O2 -march=native -DTKLB_TEST -DTKLB_NO_SIMD"
test "g++ -std=c++14 -O2 -march=native -DTKLB_TEST -DTKLB_SAMPLE_FLOAT"
test "g++ -std=c++14 -O2 -march=native -DTKLB_TEST -DTKLB_SAMPLE_FLOAT -DTKLB_NO_SIMD"
test "clang++ -std=c++14 -march=native -DTKLB_TEST -Ofast"
test "clang++ -std=c++14 -march=native -DTKLB_TEST -Ofast -DTKLB_NO_SIMD"
test "clang++ -std=c++14 -march=native -DTKLB_TEST -Ofast -DTKLB_SAMPLE_FLOAT"
test "clang++ -std=c++14 -march=native -DTKLB_TEST -Ofast -DTKLB_SAMPLE_FLOAT -DTKLB_NO_SIMD"
