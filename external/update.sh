...
rm -rf ./xsimd
rm ./master
curl -LO https://codeload.github.com/xtensor-stack/xsimd/zip/refs/heads/master
...
echo "Updating pffft"
rm -rf ./pffft
curl -LO https://codeload.github.com/marton78/pffft/zip/refs/heads/master
unzip ./master > /dev/null 2>&1
rm ./master
...
curl -LO https://codeload.github.com/xiph/speexdsp/zip/refs/heads/master
unzip ./master > /dev/null 2>&1
rm ./master
...
rm ./dirent.h
curl -LO https://raw.githubusercontent.com/tronkko/dirent/master/include/dirent.h

echo "Updating dr_wav"
rm ./dr_wav.h
curl -LO https://raw.githubusercontent.com/mackron/dr_libs/master/dr_wav.h
...
mkdir ./hiir
cd ./hiir
curl -LO http://ldesoras.free.fr/src/$HIIR
unzip ./$HIIR
rm ./$HIIR
cd ./hiir
sed -i 's/"hiir\//.\//g' *
